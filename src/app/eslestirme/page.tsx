...
function calcScore(coach: Coach, meta: Record<string, string>): number {
  ...
  // %35 — hedef üniversite/bölüm eşleşmesi
...
export default async function EslestirmePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eef3f5] to-[#cfe9e6] px-4 py-12">
